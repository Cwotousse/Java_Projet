...
public class F_AfficherRDV extends JFrame {
	...
	public F_AfficherRDV(int idPersonne) {
		...
		try{
			...
			String[] columns = new String[] { "N°","Jour début", "jour fin", "heure debut", "heure fin", "Libellé", "Elèves min", "Eleves actuellement" ,"Moniteur", "Eleve", "Titutlaire", "type", "Prix", "Annuler" };
